...
class VideoDetailsItem extends StatefulWidget {
  Article article;

  VideoDetailsItem(this.article);

  @override
  VideoDetailsItemState createState() {
    return new VideoDetailsItemState();
  }
}

class VideoDetailsItemState extends State<VideoDetailsItem> {
  ...
  void initState() {
    ...
    print('Video Details Item');
    _createVideo();
    print("Controller Initialized${_controller.value.initialized}");
  }
  ...
  void playYoutubeVideo(String url) {
    /*FlutterYoutube.playYoutubeVideoByUrl(
      apiKey: Configs.YOUTUBE_API_KEY,
      videoUrl: url,
    );*/
  }
...
class VideoDetailsItem extends StatefulWidget {
  const VideoDetailsItem({Key key}) : super(key: key);
...
class _VideoDemoState extends State<VideoDetailsItem>
    with SingleTickerProviderStateMixin {
